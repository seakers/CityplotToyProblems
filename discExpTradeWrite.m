...
writeCityplotStuff('discExpTrade',pArchs,dist,-pMets,{'obj1','obj2','count lo'},{'Criterion','sammon'});
...
writeCityplotStuff('discExpTrade_weightedDist',pArchs,dist2_T,-pMets,{'obj1','obj2','count lo'},{'Criterion','sammon'});